<template>
  <div class="section py-4 text-white h-full" style="background: #1d1e26; min-height: 250px;">
    <div class=" h-full ">
      ...
      <a href="https://docs.onsecondary.com" target="_blank" class="no-underline inline-block text-sm text-gray-200 hover:text-purple-300">Official Docs</a>
         

          <a href="https://etherscan.io/address/0xdb3b9730353232d972b4e0ceff1297b6760d127b" target="_blank" class="no-underline inline-block text-sm text-gray-200 hover:text-purple-300 ">Club Contract</a>
           <a href="https://etherscan.io/address/0xd628f9ff5bbf1cd61acc1b7b9d6dc7798a1c33f2" target="_blank" class="no-underline inline-block text-sm text-gray-200 hover:text-purple-300">Reserve Token</a>
